...
//             {/* Social icons (commented out) - kept as is */}
//             {/* <div className="mt-6 flex items-center gap-3">
//               {socialLinks.map((social) => (
//                 <a
//                   key={social.label}
...
//   { icon: <FaInstagram />, url: "https://instagram.com", label: "Instagram" },
//   { icon: <FaFacebookF />, url: "https://facebook.com", label: "Facebook" },
//   { icon: <FaEnvelope />, url: "mailto:info@advait.com", label: "Email" },
// ];
...
//           <div className="lg:col-span-3">
//             <Link to="/" className="flex items-center gap-3">
//               <img src={logo} alt="Advait Financial Services" className="h-10 w-auto object-contain" />
//               <span className="flex flex-col leading-tight">
//                 <span className="font-heading-font text-2xl font-semibold text-white-color">Advait</span>
//                 <span className="text-xs tracking-wide text-white-color/70">Financial Services</span>
//               </span>
//             </Link>
//             <div className="mt-4 h-[3px] w-14 rounded-full bg-primary-color" />
//             <p className="mt-5 font-body-font text-sm leading-relaxed text-white-color/70">
//               Smart investments. Secure future. We help you make informed financial decisions, grow your wealth and achieve your life goals with confidence.
//             </p>
//             <div className="mt-6 flex items-center gap-3">
//               {socialLinks.map((social) => (
//                 <a
...
//           <div className="lg:col-span-3 lg:border-l lg:border-white-color/10 lg:pl-8">
//             <h4 className="mb-6 font-heading-font text-lg font-semibold text-primary-color">Contact Us</h4>
//             <ul className="space-y-4">
//               <li className="flex items-center gap-3">
//                 <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary-color/15 text-primary-color">
//                   <FaPhoneAlt className="text-sm" />
//                 </span>
//                 <a href="tel:+919876543210" className="font-body-font text-sm text-white-color/80 hover:text-primary-color">+91 9265474210</a>
//               </li>
//               <li className="flex items-center gap-3">
//                 <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary-color/15 text-primary-color">
//                   <FaEnvelope className="text-sm" />
//                 </span>
//                 <a href="mailto:info@advait.com" className="font-body-font text-sm text-white-color/80 hover:text-primary-color">info@advait.com</a>
//               </li>
//               <li className="flex items-start gap-3">
//                 <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary-color/15 text-primary-color">
//                   <FaMapMarkerAlt className="text-sm" />
//                 </span>
//                 <span className="font-body-font text-sm leading-relaxed text-white-color/80">Ahmedabad - 380060, Gujarat, India</span>
//               </li>
//             </ul>
//           </div>
//         </div>

//         {/* ===== BOTTOM BAR – now with design credit on one line ===== */}
//         <div className="mt-10 flex flex-col gap-4 border-t border-white-color/10 pt-6 md:flex-row md:items-center md:justify-between">
//           {/* Copyright */}
//           <p className="font-body-font text-sm text-white-color/70 whitespace-nowrap">
//             © 2026 Advait Financial Services. All Rights Reserved.
//           </p>

//           {/* Disclaimer with shield */}
//           <div className="flex items-center gap-3">
//             <FaShieldAlt className="text-2xl shrink-0 text-primary-color" />
//             <p className="font-body-font text-xs leading-relaxed text-white-color/70 sm:text-sm">
...
//           {/* Legal links + Design Credit – all in one line */}
//           <div className="flex flex-wrap items-center gap-x-4 gap-y-2 font-body-font text-sm font-medium text-white-color">
//             <Link to="/privacy-policy" className="hover:text-primary-color transition-colors">
//               Privacy Policy
//             </Link>
//             <span className="text-white-color/30">|</span>
//             <Link to="/terms-and-conditions" className="hover:text-primary-color transition-colors">
//               Terms &amp; Conditions
//             </Link>
//             <span className="text-white-color/30">|</span>
//             <span className="text-white-color/70 whitespace-nowrap">
//               Design &amp; Developed By Krishi Koshti
//             </span>
//           </div>
//         </div>
//       </div>
...
const ourServices = [
  { label: "SIP Investment", path: "/services/sip-investment" },
  {
    label: "Systematic Withdraw Plan",
    path: "/services/systematic-withdraw-plan",
  },
  ...
  { label: "Wealth Creation", path: "/services/wealth-creation" },
  {
    ...
    path: "/services/child-education-planning",
  },
  { label: "Wealth Protection", path: "/services/wealth-protection" },
];
...
const FooterLinkList = ({ title, links }) => (
  <div>
    <h4 className="mb-5 font-heading-font text-base sm:text-lg font-semibold text-primary-color">
      {title}
    </h4>
    <ul className="space-y-3">
      {links.map((item) => (
        <li key={item.path}>
          <Link
            ...
            className="group flex items-center gap-2 font-body-font text-sm text-white-color/80 transition-colors duration-200 hover:text-primary-color"
          >
            <FaChevronRight className="text-[10px] shrink-0 text-primary-color transition-transform duration-200 group-hover:translate-x-1" />
...
const Footer = () => {
  return (
    <footer className="w-full bg-black-color px-4 py-10 sm:px-6 sm:py-12 lg:px-14 lg:py-16">
      <div className="mx-auto max-w-[1600px]">
        {/* Top Grid */}
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              />
              <span className="flex flex-col leading-tight">
                <span className="font-heading-font text-xl sm:text-2xl font-semibold text-white-color">
                  Advait
                </span>
                <span className="text-xs tracking-wide text-white-color/70">
                  Financial Services
            ...
            <div className="mt-4 h-[3px] w-14 rounded-full bg-primary-color" />
            <p className="mt-5 max-w-md font-body-font text-sm leading-relaxed text-white-color/70">
              Smart investments. Secure future. We help you make informed
              financial decisions, grow your wealth and achieve your life goals
              with confidence.
            </p>
          </div>
          ...
          {/* Contact */}
          <div className="sm:col-span-2 lg:col-span-3 lg:border-l lg:border-white-color/10 lg:pl-8">
            <h4 className="mb-5 font-heading-font text-base sm:text-lg font-semibold text-primary-color">
              Contact Us
            </h4>
            <ul className="space-y-4">
