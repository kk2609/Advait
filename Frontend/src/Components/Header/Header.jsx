    ...
    <header className="sticky top-0 z-50 w-full bg-white-color/95 backdrop-blur-sm">
      <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-10 xl:px-16">
        ...
        <Link to="/" className="flex items-center gap-2">
          {/* <span className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-color/10 text-2xl text-primary-color">
            <IoMdTrendingUp />
          </span> */}
        ...
        {/* Desktop Nav */}
         <nav className="hidden items-align-center gap-8 lg:flex">
          ...
          <div className="group relative">
            <button className="flex items-center gap-1 font-body-font text-sm font-medium text-dark-color transition-colors duration-200 group-hover:text-primary-color">
              Services
      ...
      >
        <nav className="flex flex-col gap-1 px-4 py-4">
          ...
          <button
            ...
            className="flex items-center justify-between rounded-lg px-3 py-2 font-body-font text-sm font-medium text-dark-color"
          >
            Services
            <FaChevronDown
