          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-5">
              ...
              <button
                type="submit"
                disabled={sending}
                className={`mt-1 flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 py-3.5 text-sm font-semibold text-white shadow-md shadow-orange-500/25 transition-colors ${
                  sending
