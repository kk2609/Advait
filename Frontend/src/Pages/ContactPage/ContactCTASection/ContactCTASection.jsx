        ...
        <div className="relative px-6 sm:px-10 lg:px-16 pt-14 sm:pt-16 lg:pt-20 pb-10 sm:pb-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl xl:text-[3.25rem] leading-tight text-[#0B1F3A] mb-6">
              Ready to Take the{" "}
              <span className="text-orange-500">Next Step?</span>
            </h2>

            <p className="text-slate-500 text-base sm:text-lg leading-relaxed mb-10">
              Let&apos;s build a financial strategy designed around{" "}
              <span className="font-semibold text-slate-600">
                your goals, priorities, and future.
              </span>{" "}
              Whether you&apos;re planning your investments, building wealth,
              or preparing for the future, our team is here to guide you with
